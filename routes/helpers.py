...
def get_css_guide_instruction(css_links=None):
    ...
    return (
        ...
        "10. QUY TẮC SỬ DỤNG HEADING: Các thẻ heading cấp bậc BẮT BUỘC phải được đặt ngay bên trong các thẻ wrapper tương ứng. Cụ thể: `.con-box > h4.h4-tit01`, `.con-box02 > h5.h5-tit01`, và `.con-box03 > h6.h6-tit01`. Chỉ sử dụng các thẻ heading này sau đúng thẻ wrapper được quy định.\n"

...
- **	emplates/ và static/**: HTML, CSS, JS cho Web UI Flask gốc.
- **ssets/**: Tài nguyên deploy.
  - ssets/ai_prompts/: HTML mồi.
  - ssets/img/: Hình tĩnh.
  - ssets/layout/: Layout tĩnh.
...
# 3. Đặc tả UI/UX đầy đủ (Từ file cũ)
